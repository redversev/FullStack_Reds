...
const ordenarSelect = document.querySelector('#ordenadorSelect')

ordenarSelect.addEventListener('change', function (event) {
    ...
    switch(valorSeleccionado){
        ...
        productos = productos.sort(comparator)

        productos.forEach(function (producto) {
            // console.log(contenido)
            contenidoNuevo += `<div class="articulo" data-value="${producto.datavalue}"><img src="${producto.imagen}" alt="${producto.nombre}">
          <div class="datos"><div class="nombre">${producto.nombre}</div><div class="precio">${producto.precio}</div></div></div>`
        })
        console.log(contenido)
